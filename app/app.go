...
import (
	...
	appparams "github.com/Switcheo/polynetwork-cosmos/app/params"
	"github.com/Switcheo/polynetwork-cosmos/x/polynetworkcosmos"
	polynetworkcosmoskeeper "github.com/Switcheo/polynetwork-cosmos/x/polynetworkcosmos/keeper"
	polynetworkcosmostypes "github.com/Switcheo/polynetwork-cosmos/x/polynetworkcosmos/types"
...
var (
	...
	maccPerms = map[string][]string{
		...
		btcxtypes.ModuleName:           {authtypes.Minter, authtypes.Burner},
	}
...
func New(
	...
	app.polynetworkcosmosKeeper = *polynetworkcosmoskeeper.NewKeeper(
		appCodec, keys[polynetworkcosmostypes.StoreKey], keys[polynetworkcosmostypes.MemStoreKey],
	)
